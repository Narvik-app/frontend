  ...
  <div class="flex flex-col gap-4 relative">
    <div class="flex flex-wrap justify-center">
      ...
      <UPopover v-model:open="popoverOpen">
        ...
        <template #content>
          <GenericDateRangePicker :date-range="selectedRange" @range-updated="(range) => {console.log(range); saleStore.setSelectedRange(range); popoverOpen = false; saleStore.getSales();}" />
        </template>
      </UPopover>
